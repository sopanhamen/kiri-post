...
import { useActions, useTypedSelector } from '@store/hook';
...
const Home: NextPage = () =>
{
    ...
    const selectedTodoId = useTypedSelector((state) => state.selectedTodo);
    const editedCount = useTypedSelector((state) => state.counter);
    ...
    const handleCreateNewTodo = (e: FormEvent<HTMLFormElement>): void =>
    {
        ...
        createTodoActionCreator({ desc: newTodoInput });
        setNewTodoInput(``);
    };

    const handleSelectTodo = (todoId: string) => (): void =>
    {
        selectTodoActionCreator({ id: todoId });
    };
    ...
    const handleDelete = (): void =>
    {
        ...
        removeTodoActionCreator({ id: selectedTodoId });
    };
